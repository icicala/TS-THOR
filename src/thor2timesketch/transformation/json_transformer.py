...
from thor2timesketch.transformation.json_pre_transformer import JsonPreTransformer
...
class JsonTransformer:
    def __init__(self) -> None:
        ...
        self.pre_transformer = JsonPreTransformer()
    ...
    def _generate_mapped_logs(self, valid_thor_logs: Iterator[Dict[str, Any]], filters: FilterFindings) -> Iterator[Dict[str, Any]]:
        ...
        for raw_json in valid_thor_logs:
            for json_line in self.pre_transformer.pre_transform_thor_logs(raw_json):
                try:
