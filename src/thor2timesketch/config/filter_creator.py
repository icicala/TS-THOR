...
class FilterCreator:
    ...
    def _load_default_config(self) -> Dict[str, Any]:
        try:
            ...
            raise FilterConfigError(
                f"Failed to load default filter '{DEFAULT_FILTER}': {e}"
            )
